pipeline {
    ...
    environment {
        ...
        repoUri = "203918847014.dkr.ecr.eu-central-1.amazonaws.com/webform"
        repoRegistryUrl = "https://203918847014.dkr.ecr.eu-central-1.amazonaws.com"
        registryCreds = 'ecr:eu-central-1:awscreds'
        cluster = "webform"
        service = "webform-svc"
        region = 'eu-central-1'
    }
